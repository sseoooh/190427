  ...
  <div id="full_content" class="row content">
    <div id="left_content" class="col-sm-3 sidenav">
      ...
      <div class="input-group">
        <input id="cust_list" type="text" class="form-control" placeholder="Search Blog..">
        <span class="input-group-btn">
          <button id="cust_list_btn" class="btn btn-default" type="button">
...
<script src="<%=application.getContextPath()%>/resources/js/cust.js"></script>
<script>
